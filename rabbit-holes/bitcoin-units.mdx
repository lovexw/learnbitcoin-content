...
section: rabbit-hole
tagline: "BTC, sats, mBTC, uBTC, Finney. Which unit to use, when, and why there are so many of them."
order: 1
estimatedMinutes: 9
sources:
...
The other units (mBTC, uBTC, Finney) are mostly historical or community-specific. If you're learning Bitcoin in 2026, learning BTC and sats is sufficient.

...
|---|---|---|
| 2^32 | 4.3 x 10^9 | IPv4 address space |
| 2^64 | 1.8 x 10^19 | Grains of sand on Earth |
| 2^128 | 3.4 x 10^38 | Atoms in your body |
| 2^160 | 1.5 x 10^48 | Bitcoin's address space (160-bit hashes) |
| 2^192 | 6.3 x 10^57 | Atoms in the Sun |
| 2^224 | 2.7 x 10^67 | Atoms in the Milky Way |
| 2^256 | 1.2 x 10^77 | Bitcoin's private key space - close to the atom count of the observable universe |

...
hasInteractive: []
ogImage: "/diagrams/og/seed-backup.jpg?v=2"
ogImageAlt: "Four generations of Trezor hardware wallets in a row on light wood, oldest to newest: the two-button Model One, the touchscreen Model T, the Safe 3, and the larger touchscreen Safe 5. The hardware keeps changing; the seed backup you make today has to outlive all of it."
---
...
Hardware wallets that support SLIP-39 include Trezor and a few other devices (via different paths). Some software wallets support it; most do not.

...
The transaction had two outputs, each set to roughly 9.2 x 10^18 satoshis - just past the overflow threshold. Their sum overflowed to a small negative number. The validation function said "looks fine." The transaction got mined.

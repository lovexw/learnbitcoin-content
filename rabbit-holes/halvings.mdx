...
**Before halving 4** (block 839,999): a miner that found a block received 6.25 BTC + accumulated fees (typically 0.1-0.5 BTC). Total: about 6.35-6.75 BTC.

**After halving 4** (block 840,000): same miner finds a block, gets 3.125 BTC + same accumulated fees. Total: about 3.225-3.625 BTC.

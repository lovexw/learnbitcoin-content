...
Go deeper in the [Mempool rabbit hole](/rabbit-hole/mempool) - fee markets, eviction rules, RBF, and what a "stuck" transaction actually looks like at the protocol level. Watch the live mempool state on the [Node Status page](/node/) or in the [Mining rabbit hole section 6](/rabbit-hole/mining).

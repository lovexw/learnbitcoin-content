...
[BIP-159](https://github.com/bitcoin/bips/blob/master/bip-0159.mediawiki) defines the **NODE_NETWORK_LIMITED** service bit, which lets a Bitcoin node advertise that it stores only recent blocks (typically the last 288 blocks, about 2 days) rather than the full chain.

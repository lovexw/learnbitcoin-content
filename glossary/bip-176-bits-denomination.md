...
draft: false
shortDefinition: "Proposed using 'bits' (1 uBTC) as a user-friendly unit for smaller denominations of Bitcoin."
keyTakeaways:
...
[BIP-176](https://github.com/bitcoin/bips/blob/master/bip-0176.mediawiki) proposed using "bits" as a standard small-denomination unit for Bitcoin. **1 bit = 1 microbitcoin (uBTC) = 100 [satoshis](/glossary/satoshi-unit) = 0.000001 BTC.**
